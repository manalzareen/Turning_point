...
<View style = {{flexDirection:"row",alignContent:'space-around',marginTop:30,justifyContent:'space-around',
    width:"90%",height:180 ,backgroundColor:"white",marginLeft:10, borderRadius:20}}>
         ...
         <Image
            source={require('../assets/gathik.jpg')}
            style={{width:90,height:100,marginTop:1,marginRight:-1600}}></Image>
...
<TouchableOpacity onPress={() => openWebsite("https://www.gatikedu.com/landing-page/?gclid=Cj0KCQjwtsCgBhDEARIsAE7RYh2WtdeYzrZq4uHjNDgZxpThI71WqEYmjpt4sIWHsBdqN-ykWCiMB9UaAj_AEALw_wcB")}>
      <Text style = {{marginTop:150,marginLeft:-260,fontSize:20 ,color:"#DEA5A5",fontWeight:'BOLD',}}>𝚁𝚎𝚊𝚍  𝙼𝚘𝚛𝚎....</Text>
      </TouchableOpacity>
